    ...
    <PageLayout mainClass="content-page review-detail-page">
        <section className="review-detail-card">
          ...
          <div className="review-detail-media">
            <img loading="lazy" decoding="async" src={image} alt={review.title} />
          </div>
        ...
        <section className="review-detail-card">
          ...
          {post.imageUrl || post.videoUrl ? (
            <div className="review-detail-media-stack">
              {post.imageUrl ? (
                <div className="review-detail-media">
                  <img loading="lazy" decoding="async" src={resolveCommunityMediaUrl(post.imageUrl)} alt={`${post.title} 첨부 이미지`} />
                </div>
              ) : null}
              {post.videoUrl ? (
                <div className="review-detail-video">
            ...
            filtered.map((eventItem) => (
              ...
              >
                <div className="event-card-media">
                  <img loading="lazy" decoding="async" src={eventItem.image || FALLBACK_EVENT_IMAGE} alt={eventItem.title} />
                </div>
