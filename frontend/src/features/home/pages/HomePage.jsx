...
const HOME_IMAGES = {
  hero: "/assets/images/home/main-hero/이끌림 필라테스 메인 페이지 상단 이미지.webp",
              ...
              <article className="sunlit-news-card" key={item.source}>
                ...
                {item.source === "blog" ? (
                  <div className="sunlit-news-platform-thumb sunlit-news-platform-thumb--blog">
                    <img loading="lazy" decoding="async" src="/assets/images/naver-blog-logo.webp" alt="Naver Blog" />
                  </div>
                ) : item.source === "instagram" ? (
                  <div className="sunlit-news-platform-thumb sunlit-news-platform-thumb--instagram">
                    <img loading="lazy" decoding="async" src="/assets/images/instagram-logo.jpg" alt="Instagram" />
                  </div>
