// 파일 역할: 이용약관·개인정보 처리방침·마케팅 수신 동의 전문을 한 곳에 보관합니다.
//
// 가입 화면의 동의 모달과 공개 URL 페이지가 같은 원본을 쓰게 하려고 분리했습니다.
// 스토어 심사에서 앱 내 문구와 공개 URL 문구가 다르면 반려 사유가 되므로
// 두 곳이 절대 갈라지지 않도록 이 파일 하나만 고치면 되게 합니다.
  ...
  privacy: {
    ...
    body: (
      <div style={{ whiteSpace: "normal" }}>
        ...
        <p style={{ fontWeight: 700, marginTop: "18px", marginBottom: "6px" }}>6. 개인정보의 국외 이전</p>
        <p style={{ margin: "0 0 8px" }}>
          회사는 서비스 제공을 위해 아래와 같이 개인정보를 국외로 이전합니다. 이전되는 개인정보는 계약 이행과
          서비스 제공 목적에 한정되며, 정보주체는 국외 이전을 거부할 수 있습니다. 다만 거부 시 알림 수신 등
          해당 기능의 이용이 제한될 수 있습니다.
        </p>
        <table style={{ width: "100%", borderCollapse: "collapse", margin: "0 0 8px", fontSize: "12px" }}>
          <thead>
            <tr style={{ background: "#f0f0f0" }}>
              <th style={{ border: "1px solid #ccc", padding: "7px 10px", textAlign: "left", fontWeight: 600 }}>이전받는 자</th>
              <th style={{ border: "1px solid #ccc", padding: "7px 10px", textAlign: "left", fontWeight: 600 }}>이전 국가</th>
              <th style={{ border: "1px solid #ccc", padding: "7px 10px", textAlign: "left", fontWeight: 600 }}>이전 항목</th>
              <th style={{ border: "1px solid #ccc", padding: "7px 10px", textAlign: "left", fontWeight: 600 }}>이전 목적 및 보유기간</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td style={{ border: "1px solid #ccc", padding: "7px 10px" }}>Amazon Web Services, Inc.</td>
              <td style={{ border: "1px solid #ccc", padding: "7px 10px" }}>미국</td>
              <td style={{ border: "1px solid #ccc", padding: "7px 10px" }}>서비스 이용 기록, 접속 로그</td>
              <td style={{ border: "1px solid #ccc", padding: "7px 10px" }}>클라우드 인프라 운영 · 회원 탈퇴 시까지</td>
            </tr>
            <tr>
              <td style={{ border: "1px solid #ccc", padding: "7px 10px" }}>Google LLC (Firebase Cloud Messaging)</td>
              <td style={{ border: "1px solid #ccc", padding: "7px 10px" }}>미국</td>
              <td style={{ border: "1px solid #ccc", padding: "7px 10px" }}>푸시 알림 토큰, 기기 식별 정보</td>
              <td style={{ border: "1px solid #ccc", padding: "7px 10px" }}>알림 발송 · 알림 수신 동의 철회 또는 탈퇴 시까지</td>
            </tr>
          </tbody>
        </table>
        <p style={{ margin: "0 0 4px" }}>
          ※ 이전 방법은 서비스 이용 시점에 정보통신망을 통한 전송이며, 이전받는 자의 개인정보 보호책임자 연락처는
  ...
  marketing: {
    ...
    body: (
      <div style={{ whiteSpace: "normal" }}>
        ...
        <p style={{ margin: "0 0 4px" }}>
          21시부터 다음 날 8시까지의 야간 시간대에는 별도로 동의한 경우에만 광고성 정보를 발송하며,
          동의하지 않아도 주간 시간대 수신과 서비스 이용에는 제한이 없습니다.
        </p>
        <p style={{ margin: "0 0 4px" }}>회사는 2년마다 마케팅 정보 수신 동의 여부를 재확인합니다.</p>
